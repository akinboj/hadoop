...
if [ "$MULTIHOMED_NETWORK" = "1" ]; then
    ...
    addProperty /etc/hbase/hbase-site.xml hbase.master.port 17314
    addProperty /etc/hbase/hbase-site.xml hbase.master.info.port 17312
    addProperty /etc/hbase/hbase-site.xml hbase.regionserver.port 17316
    addProperty /etc/hbase/hbase-site.xml hbase.regionserver.info.port 17318
